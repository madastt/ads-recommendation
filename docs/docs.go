    ...
    "paths": {
        ...
        "/events": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Dane zdarzenia (ad_id, event_type: 'impression'/'click', user_context)",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
